      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <div
              ...
              className="relative"
            >
              <button className="flex items-center text-gray-900 hover:text-[#009BB1] px-3 py-2 font-medium">
                SERVICES <ChevronDown className="ml-1 w-4 h-4" />
              </button>
              {servicesOpen && (
                <div className="absolute top-full left-0 mt-0 w-56 bg-white/95 shadow-lg rounded-md font-sans text-base">
        ...
        {isMobileMenuOpen && (
          <div
            ...
            className="fixed top-[87px] right-0 bottom-0 left-0 bg-white/60 z-40 lg:hidden"
            role="presentation"
          />
        )}
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden bg-white/95 border-t border-gray-200 absolute left-0 top-[87px] w-full z-50 h-[calc(100vh-87px)] overflow-y-auto">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <Link
                to="/home"
                className="block px-3 py-2 text-gray-900 hover:text-[#009BB1]"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                HOME
              </Link>
                ...
                <div className="pl-6 space-y-1">
                  {services.map((service) => (
                    <HashLink
                      ...
                      scroll={(el) => {
                        setTimeout(() => {
                          const yOffset = -87; // navbar offset
                          const y =
