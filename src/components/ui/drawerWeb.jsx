...
function DrawerOverlay({ className, ...props }) {
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed left-0 right-0 bottom-0 top-[0] z-10 bg-white/70",
        className,
      )}
      {...props}
    />
...
function DrawerHeader({ className, ...props }) {
  return (
    <div
      ...
      className={cn(
        "flex flex-col gap-0.5 p-6 bg-gradient-to-r from-[#009BB1] to-[#B2519A] text-white group-data-[vaul-drawer-direction=bottom]/drawer-content:text-center group-data-[vaul-drawer-direction=top]/drawer-content:text-center md:gap-1.5 md:text-left",
        className,
      )}
      {...props}
    />
...
function DrawerTitle({ className, ...props }) {
  return (
    <DrawerPrimitive.Title
      ...
      className={cn("text-white font-bold text-2xl mb-2", className)}
      {...props}
    />
  )
}
...
function DrawerDescription({ className, ...props }) {
  return (
    <DrawerPrimitive.Description
      ...
      className={cn("text-white/90 text-base leading-relaxed", className)}
      {...props}
    />
  )
}
